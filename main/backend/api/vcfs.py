...
NIMOG_JOBS_DIR = Path(os.environ.get("NIMOG_JOBS_DIR", str(Path(__file__).resolve().parents[2] / "nimog" / "jobs")))
DELETED_PATHS_FILE = Path(os.environ.get("DELETED_VCF_PATHS_FILE", "/data/app/deleted_vcf_paths.json"))
